/*
    ...
    Cynthia Flat-Mode Platform's Core Version 0.01b
...
Start:
    ...
    CPD     dd  400h - ($ - Start) Dup (0)  ;Cynthia's Page Directory
    CT1     dd  400h Dup (0)
    CT2     dd  400h Dup (0)
...
Server:
    ...
    cmp     eax, 'EPAG'
    je      Server.Enable_Paging

    mov     eax, 'NIMP'
    ret

;============================================================================
Server.Enable_Paging:
    mov     eax, cr0
    test    eax, 1 Shl 31
    jnz     .Ret
    ...
    mov     ebx, CPD
    mov     dword ptr [ebx+000h], CT1 + 07h
    mov     dword ptr [ebx+004h], CT2 + 07h
...
;============================================================================
    ...
    ServiceTableFlg dd  32 Dup (0)              ;00-1F
                    dd  17 Dup (0)              ;20-30
                    dd  00000000h               ;31
                    dd  256-32-16-1-1 Dup (0)   ;32-FF

    ; Bit 31 : Save Registers
